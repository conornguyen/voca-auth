...
- [ ] **Task 1: Setup Drizzle Schema and DB Migrations** *(Phase: GREEN)* - [Skill: `db`]
...
- [ ] **Task 2: Write Failing Tests for Subdomain Registration** *(Phase: RED)* - [Skill: `qa`]
...
- [ ] **Task 3: Implement Tenant Provisioning API / Server Action** *(Phase: GREEN)* - [Skill: `nextjs-dev` & `db`]
...
- [ ] **Task 4: Optimize Query / Add Zod Validation** *(Phase: REFACTOR)* - [Skill: `pm` / `plan`]
...
- [ ] **Task 5: Write Failing Tests for Session Minting** *(Phase: RED)* - [Skill: `qa`]
...
- [ ] **Task 6: Implement `/api/auth/session` Route** *(Phase: GREEN)* - [Skill: `auth` & `nextjs-dev`]
...
- [ ] **Task 7: Write Failing Tests for Edge Interception** *(Phase: RED)* - [Skill: `qa`]
...
- [ ] **Task 8: Write Edge Middleware for Tenant Resolution** *(Phase: GREEN)* - [Skill: `auth` & `nextjs-dev`]
  - Create `middleware.ts` to decode the wildcard cookie on edge requests, assert Role-matching against `Host` headers.
- [ ] **Task 9: Clean Code & Secret Management Verification** *(Phase: REFACTOR)* - [Skill: `infra`]
...
- [ ] **Task 10: Write Failing Tests for Pub/Sub Emission** *(Phase: RED)* - [Skill: `qa`]
...
- [ ] **Task 11: Implement Google Cloud Pub/Sub Client Abstraction** *(Phase: GREEN)* - [Skill: `infra`]
  - Implement abstraction wrapping `@google-cloud/pubsub`. 
  - Wire it inside the `createWorkspace` completion lifecycle.
- [ ] **Task 12: Network Resilience / Retry Logic** *(Phase: REFACTOR)* - [Skill: `infra`]
